  ...
  return (
    ...
    >
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-accent text-accent-foreground text-xs sm:text-sm font-medium mb-4 sm:mb-6"
      >
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-3 sm:mb-4 leading-tight">
        Learn Smarter with{" "}
        <span className="text-gradient">SummarIQ</span>
      </h1>
